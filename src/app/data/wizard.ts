...
export const wizardSummaryHighlights: ReadonlyArray<WizardSummaryHighlight> = [
  {
    ...
    localizations: {
      ...
      ta: { name: "நன்கு ஒளியூட்டப்பட்ட பாதைகள்", description: "ஸ்மார்ட் விளக்குகளுடன் பாதுகாப்பான மாலை பகுதிகள்" },
  ...
  },
  {
    ...
    localizations: {
      ...
      fi: { name: "Kierrosreitti", description: "Alkaa ja päättyy lähellä nykyistä sijaintiasi" },
      fr: {
        name: "Parcours en boucle",
        description: "Commence et s'achève près de votre position actuelle",
      },
      gd: {
        name: "Slighe-chearcaill",
        description: "A' tòiseachadh is a' crìochnachadh faisg ort fhèin",
      },
      he: { name: "מסלול מעגלי", description: "מתחיל ומסתיים ליד המיקום הנוכחי שלכם" },
      hi: { name: "लूप रूट", description: "आपके वर्तमान स्थान के पास शुरू और खत्म होता है" },
      it: {
        name: "Percorso ad anello",
        description: "Parte e termina vicino alla tua posizione attuale",
      },
      ja: { name: "ループルート", description: "現在地の近くで開始・終了します" },
      ko: { name: "루프 경로", description: "현재 위치 근처에서 시작하고 종료합니다" },
      nb: { name: "Sløyferute", description: "Starter og slutter nær der du er nå" },
      nl: { name: "Lusroute", description: "Begint en eindigt dicht bij je huidige locatie" },
      pl: {
        name: "Trasa pętlowa",
        description: "Zaczyna się i kończy blisko Twojej obecnej lokalizacji",
      },
      pt: {
        name: "Rota circular",
        description: "Começa e termina perto da sua localização actual",
      },
      ru: {
        name: "Кольцевой маршрут",
        description: "Начинается и заканчивается рядом с вашим текущим положением",
      },
      sv: { name: "Slingrande rutt", description: "Börjar och slutar nära din nuvarande plats" },
      ta: { name: "வளைய பாதை", description: "உங்கள் தற்போதைய இருப்பிடம் அருகே தொடங்கி முடிகிறது" },
      th: { name: "เส้นทางวนรอบ", description: "เริ่มและจบใกล้ตำแหน่งปัจจุบันของคุณ" },
      tr: { name: "Döngü rotası", description: "Mevcut konumunun yakınında başlayıp bitiyor" },
      vi: { name: "Lộ trình vòng", description: "Bắt đầu và kết thúc gần vị trí hiện tại của bạn" },
      "zh-CN": { name: "环形路线", description: "从你当前位置附近出发并返回" },
      "zh-TW": { name: "環狀路線", description: "於你目前位置附近起點與終點" },
    },
  },
  {
    id: "easy",
    ...
    localizations: {
      ...
      fr: {
        ...
        description: "Pentes douces adaptées à un rythme tranquille",
      },
      gd: {
      ...
      it: {
        ...
        description: "Pendenze graduali adatte a un ritmo rilassato",
      },
      ...
      nl: {
        name: "Lage moeilijkheid",
        description: "Geleidelijke hellingen voor een relaxed tempo",
      },
      pl: {
        name: "Niska trudność",
        description: "Łagodne wzniesienia sprzyjające spokojnemu tempu",
      },
...
export const wizardWeatherSummary: WizardWeatherSummary = {
  ...
  windLocalizations: {
    "en-GB": { name: "light breeze" },
    "en-US": { name: "light breeze" },
    ar: { name: "نسيم خفيف" },
    cy: { name: "awel ysgafn" },
    da: { name: "let brise" },
  ...
  skyLocalizations: {
    "en-GB": { name: "clear skies" },
    "en-US": { name: "clear skies" },
    ar: { name: "سماء صافية" },
    cy: { name: "awyr glir" },
...
export const wizardGeneratedStops: ReadonlyArray<WizardGeneratedStop> = [
  {
    ...
    noteLocalizations: {
      "en-GB": { name: "Friendly baristas, ideal for takeaway" },
      "en-US": { name: "Friendly baristas, ideal for takeaway" },
  ...
  },
  {
    ...
    localizations: {
      "en-GB": { name: "Graffiti Passage", description: "Open-air gallery of rotating murals" },
      "en-US": { name: "Graffiti Passage", description: "Open-air gallery of rotating murals" },
    ...
    noteLocalizations: {
      "en-GB": { name: "Photo spot" },
      "en-US": { name: "Photo spot" },
      ar: { name: "نقطة تصوير" },
  ...
  },
  {
    ...
    noteLocalizations: {
      "en-GB": { name: "Rest area" },
      "en-US": { name: "Rest area" },
...
export const wizardRouteSummary: WizardRouteSummary = {
  localizations: {
    ...
    "en-US": {
      name: "Hidden Gems Loop",
      description:
        "A personalized walk blending street art laneways, independent cafés, and quiet waterfront viewpoints.",
    },
    ar: {
      name: "حلقة الجواهر المخفية",
      description:
        "جولة مخصصة تمزج أزقة فن الشارع والمقاهي المستقلة وإطلالات هادئة على الواجهة البحرية.",
    },
    cy: {
      name: "Cylch Trysorau Cudd",
      description:
        "Taith gerdded bersonol sy'n cyfuno lonydd celf stryd, caffis annibynnol a golygfeydd tawel ar hyd y glannau.",
    },
    da: {
      name: "Løkke med skjulte perler",
      description:
        "En personlig gåtur, der blander gader med gadekunst, uafhængige caféer og rolige udsigtspunkter ved havnefronten.",
    },
    de: {
      name: "Schleife der verborgenen Schätze",
      description:
