...
customize-crowd-heading = Уровень оживлённости
customize-elevation-heading = Предпочтение по высоте
customize-slider-distance-label = Дистанция
customize-slider-distance-aria = Ползунок дистанции
customize-slider-distance-marker-0 = 1 км
customize-slider-distance-marker-1 = 5 км
customize-slider-distance-marker-2 = 10 км
customize-slider-duration-label = Длительность
customize-slider-duration-aria = Ползунок длительности
customize-slider-duration-marker-0 = 15 мин
customize-slider-duration-marker-1 = 90 мин
customize-slider-duration-marker-2 = 180 мин
customize-crowd-option-quiet-label = Спокойно
customize-crowd-option-quiet-description = Тихие улицы
customize-crowd-option-balanced-label = Сбалансировано
customize-crowd-option-balanced-description = Местная атмосфера
customize-crowd-option-lively-label = Оживлённо
customize-crowd-option-lively-description = Популярные места
customize-elevation-option-flat-label = Плоский
customize-elevation-option-flat-description = Минимальные подъёмы
customize-elevation-option-rolling-label = Холмистый
customize-elevation-option-rolling-description = Плавные холмы
customize-elevation-option-steep-label = Крутой
customize-elevation-option-steep-description = Бросьте мне вызов
customize-surface-option-paved-label = Асфальт
customize-surface-option-trail-label = Тропа
customize-surface-option-boardwalk-label = Настил
customize-surface-option-mixed-label = Смешанный
customize-interest-nature-label = Природа
customize-interest-history-label = История
customize-interest-food-label = Еда и напитки
customize-route-preview-route-a-title = Маршрут A
customize-route-preview-route-b-title = Маршрут B
customize-route-preview-route-c-title = Маршрут C
customize-advanced-safety-title = Приоритет безопасности
customize-advanced-safety-description = Хорошо освещённые, оживлённые маршруты
customize-advanced-accessibility-title = Доступность
customize-advanced-accessibility-description = Маршруты без ступеней
customize-advanced-download-title = Офлайн-загрузка
customize-advanced-download-description = Загружайте карты и звук заранее
nav-map-label = Карта
nav-discover-label = Исследовать
...
wizard-step-three-start-over = Начать заново
wizard-step-three-save-button = Сохранить прогулку и открыть карту
wizard-step-three-dialog-title = Прогулка сохранена!
wizard-step-three-dialog-description = {$routeTitle} уже готова среди ваших сохранённых маршрутов. Запустите её сейчас или продолжайте выбирать другие варианты мастера.
wizard-step-three-dialog-close = Закрыть
wizard-step-three-dialog-view-map = Показать на карте
wizard-step-three-route-panel-aria = Сводка по циклу скрытых жемчужин
wizard-step-three-route-title = Цикл Скрытых Жемчужин
wizard-step-three-route-badge = Индивидуальный
wizard-step-three-route-distance-unit = км
wizard-step-three-stop-distance-unit-km = км
wizard-step-three-route-duration-unit = минут
wizard-step-three-route-stops-unit = остановок
wizard-step-three-stop-distance-unit = км
...
wizard-step-three-preferences-panel-aria = Применённые предпочтения
wizard-step-three-preferences-heading = Ваши предпочтения учтены
wizard-step-three-stops-panel-aria = Избранные остановки
wizard-step-three-stops-heading = Избранные остановки
wizard-step-three-highlight-lighting-detail = Безопасные вечерние отрезки с умным освещением
wizard-step-three-highlight-hidden-gems-label = Акцент на скрытых жемчужинах
wizard-step-three-highlight-hidden-gems-detail = Ожидайте тихих аллей со стрит-артом и уютных кафе
wizard-step-three-highlight-loop-label = Кольцевой маршрут
wizard-step-three-highlight-loop-detail = Начинается и заканчивается рядом с вашим текущим положением
wizard-step-three-highlight-easy-label = Низкая сложность
wizard-step-three-highlight-easy-detail = Постепенные подъёмы для комфортного темпа
wizard-step-three-stop-cafe-name = Midtown Roastery
wizard-step-three-stop-cafe-description = Эспрессо малыми партиями с местами у окна
wizard-step-three-stop-cafe-note = Дружелюбные бариста, идеально на вынос
wizard-step-three-stop-art-name = Graffiti Passage
wizard-step-three-stop-art-description = Галерея под открытым небом с меняющимися фресками
wizard-step-three-stop-art-note = Точка для фото • через {$distance} {$unit}
wizard-step-three-stop-garden-name = Whispering Oak Garden
wizard-step-three-stop-garden-description = Тихий парковый карман с тенистыми скамейками
wizard-step-three-stop-garden-note = Зона отдыха • через {$distance} {$unit}
wizard-step-three-weather-title = Идеальная погода для прогулки
wizard-step-three-weather-summary = { $temperature }, { $wind } и { $sky }
wizard-step-three-weather-reminder = Возьмите лёгкую накидку на всякий случай.
wizard-step-three-weather-sentiment = Идеально
wizard-step-three-weather-wind = лёгкий бриз
wizard-step-three-weather-sky = ясное небо
safety-header-title = Безопасность и доступность
safety-header-description = Настройте маршруты прогулок для большего комфорта и безопасности
safety-presets-heading = Предустановленные профили
safety-save-button = Сохранить предпочтения
safety-dialog-title = Предпочтения сохранены
safety-dialog-description = Ваши параметры безопасности и доступности будут учтены при планировании будущих прогулок.
safety-dialog-continue = Продолжить
safety-dialog-chip-fallback = {$id}
safety-preset-alert = Профиль «{$title}» будет применён в следующей версии.
safety-section-mobility-title = Поддержка мобильности
safety-section-mobility-description = Корректировки маршрута для более лёгкой навигации
safety-toggle-step-free-label = Маршруты без ступеней
safety-toggle-step-free-description = Избегайте лестниц и ступенек
safety-toggle-avoid-hills-label = Избегать крутых подъёмов
safety-toggle-avoid-hills-description = Ограничивайте уклоны выше 5%
safety-toggle-wider-paths-label = Предпочитать широкие дорожки
safety-toggle-wider-paths-description = Оптимально для кресел, колясок и групп
safety-section-safety-title = Функции безопасности
safety-section-safety-description = Дополнительная уверенность на прогулке
safety-toggle-busy-areas-label = Предпочитать оживлённые районы
safety-toggle-busy-areas-description = Оставайтесь в населённых зонах
safety-toggle-emergency-sharing-label = Экстренный обмен местоположением
safety-toggle-emergency-sharing-description = Делитесь местоположением с контактами
safety-toggle-avoid-isolated-label = Избегать уединённых мест
safety-toggle-avoid-isolated-description = Пропускать отдалённые участки
safety-section-comfort-title = Настройки комфорта
safety-section-comfort-description = Настройте впечатление от прогулки под себя
safety-toggle-shade-label = Приоритет тени
safety-toggle-shade-description = Выбирайте дорожки с деревьями
safety-toggle-weather-label = Адаптация к погоде
safety-toggle-weather-description = Корректируйте маршруты по погоде
safety-toggle-quiet-label = Предпочитать тихие маршруты
safety-toggle-quiet-description = Минимизируйте шум от транспорта
safety-preset-family-title = Для семей
safety-preset-family-description = Неспешный темп, остановки у площадок, много тени
safety-preset-senior-title = Для пожилых
...
walk-complete-hero-description = Удивительное путешествие по городу · Маршрут скрытых жемчужин
walk-complete-map-alt = Обзор завершённого маршрута
walk-complete-badge-route = Маршрут завершён
walk-complete-primary-distance-label = Дистанция
walk-complete-primary-duration-label = Длительность
walk-complete-secondary-calories-label = Калории
walk-complete-secondary-stops-label = Остановки
walk-complete-secondary-starred-label = Избранное
walk-complete-favourite-heading = Любимые моменты
walk-complete-actions-rate = Оценить прогулку
walk-complete-actions-share = Поделиться
walk-complete-actions-save = Сохранить маршрут
walk-complete-remix-title = Попробовать ремикс?
walk-complete-remix-description = Создайте новый маршрут, сохранив любимые места и открыв новые тайны.
walk-complete-remix-button = Сделать ремикс прогулки
walk-complete-share-section = Поделитесь своим приключением
walk-complete-share-dialog-title = Поделиться лучшими моментами
walk-complete-share-dialog-description = Экспортируйте подборку с любимыми остановками и статистикой.
walk-complete-share-dialog-cancel = Отмена
walk-complete-share-dialog-generate = Создать ролик
walk-complete-toast-rating-saved = Спасибо! Оценка сохранена для будущих рекомендаций.
...
offline-storage-subtitle = Автоматически удаляйте неиспользуемые карты через {$days} дней
offline-storage-used-label = Использовано
offline-storage-used-description = {$used} из {$total}
...
offline-downloads-undo-aria = {$title} удалён. Нажмите «Отменить», чтобы вернуть эту карту.
