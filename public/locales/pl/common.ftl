...
customize-crowd-heading = Poziom tłumu
customize-elevation-heading = Preferencja wysokości
customize-slider-distance-label = Dystans
customize-slider-distance-aria = Suwak dystansu
...
customize-slider-duration-label = Czas trwania
customize-slider-duration-aria = Suwak czasu trwania
...
customize-crowd-option-quiet-label = Spokojnie
customize-crowd-option-quiet-description = Spokojne ulice
customize-crowd-option-balanced-label = Zrównoważony
customize-crowd-option-balanced-description = Lokalny klimat
customize-crowd-option-lively-label = Tętniący życiem
customize-crowd-option-lively-description = Popularne miejsca
customize-elevation-option-flat-label = Płaski
customize-elevation-option-flat-description = Minimalne podjazdy
customize-elevation-option-rolling-label = Falisty
customize-elevation-option-rolling-description = Łagodne wzgórza
customize-elevation-option-steep-label = Stromy
customize-elevation-option-steep-description = Rzuć mi wyzwanie
customize-surface-option-paved-label = Utwardzona
customize-surface-option-trail-label = Szlak
customize-surface-option-boardwalk-label = Drewniana promenada
customize-surface-option-mixed-label = Mieszane
customize-interest-nature-label = Natura
customize-interest-history-label = Historia
customize-interest-food-label = Jedzenie i napoje
customize-route-preview-route-a-title = Trasa A
customize-route-preview-route-b-title = Trasa B
customize-route-preview-route-c-title = Trasa C
customize-advanced-safety-title = Priorytet bezpieczeństwa
customize-advanced-safety-description = Dobrze oświetlone, ruchliwe trasy
customize-advanced-accessibility-title = Dostępność
customize-advanced-accessibility-description = Trasy bez schodów
customize-advanced-download-title = Pobieranie offline
customize-advanced-download-description = Wczytaj mapy i audio z wyprzedzeniem
nav-map-label = Mapa
nav-discover-label = Odkrywaj
...
quick-walk-interests-aria = Wybierz zainteresowania dla szybkiego spaceru
quick-walk-stops-heading = Przystanki szybkiego spaceru
quick-walk-notes-heading = Notatki planistyczne
quick-walk-notes-item-1 = Zsynchronizuj plan z kalendarzem, by zarezerwować czas na odkrywanie.
quick-walk-notes-item-2 = Zabierz butelkę wielokrotnego użytku – punkty uzupełnień są oznaczone wzdłuż nabrzeża.
quick-walk-notes-item-3 = Zaproś znajomych i utrzymuj elastyczne tempo, by spacer był inkluzywny.
quick-walk-tab-map = Mapa
...
wizard-step-three-start-over = Zacznij od nowa
wizard-step-three-save-button = Zapisz spacer i pokaż mapę
wizard-step-three-dialog-title = Spacer zapisany!
wizard-step-three-dialog-description = {$routeTitle} czeka w zapisanych spacerach. Uruchom trasę teraz albo sprawdź inne opcje kreatora.
wizard-step-three-dialog-close = Zamknij
wizard-step-three-dialog-view-map = Pokaż na mapie
wizard-step-three-route-panel-aria = Podsumowanie pętli ukrytych pereł
...
wizard-step-three-preferences-heading = Twoje preferencje zastosowane
wizard-step-three-stops-panel-aria = Polecane przystanki
wizard-step-three-stops-heading = Polecane przystanki
wizard-step-three-highlight-lighting-detail = Bezpieczne wieczorne odcinki ze sprytnym oświetleniem
wizard-step-three-highlight-hidden-gems-label = Fokus na ukryte perły
wizard-step-three-highlight-hidden-gems-detail = Czekaj na ciche alejki ze street artem i niezależne kawiarnie
wizard-step-three-highlight-loop-label = Trasa pętlowa
wizard-step-three-highlight-loop-detail = Zaczyna się i kończy blisko Twojej obecnej lokalizacji
wizard-step-three-highlight-easy-label = Niska trudność
wizard-step-three-highlight-easy-detail = Łagodne wzniesienia sprzyjające spokojnemu tempu
wizard-step-three-stop-cafe-name = Midtown Roastery
wizard-step-three-stop-cafe-description = Espresso z małych partii z miejscami przy oknie
wizard-step-three-stop-cafe-note = Przyjaźni bariści, idealne na wynos
wizard-step-three-stop-art-name = Graffiti Passage
wizard-step-three-stop-art-description = Plenerowa galeria z rotującymi muralami
wizard-step-three-stop-art-note = Punkt foto • po {$distance} {$unit}
wizard-step-three-stop-garden-name = Whispering Oak Garden
wizard-step-three-stop-garden-description = Kameralny park kieszonkowy z zacienionymi ławkami
wizard-step-three-stop-garden-note = Strefa odpoczynku • po {$distance} {$unit}
wizard-step-three-weather-title = Idealna pogoda na spacer
wizard-step-three-weather-summary = {$temperature}, {$wind} i {$sky}
wizard-step-three-weather-reminder = Na wszelki wypadek zabierz lekkie warstwy.
wizard-step-three-weather-sentiment = Idealnie
wizard-step-three-weather-wind = lekka bryza
wizard-step-three-weather-sky = bezchmurne niebo
safety-header-title = Bezpieczeństwo i dostępność
safety-header-description = Dostosuj trasy spacerowe dla większego komfortu i bezpieczeństwa
safety-presets-heading = Wstępne profile
safety-save-button = Zapisz preferencje
safety-dialog-title = Preferencje zapisane
safety-dialog-description = Ustawienia bezpieczeństwa i dostępności zostaną uwzględnione w przyszłym planowaniu tras.
safety-dialog-continue = Kontynuuj
...
safety-toggle-step-free-description = Unikaj schodów i stopni
safety-toggle-avoid-hills-label = Omijaj strome wzniesienia
...
discover-skip = Pomiń
discover-hero-title = Odkryj swój idealny spacer
discover-hero-description = Powiedz nam, co Cię interesuje, a stworzymy magiczne trasy dopasowane do Ciebie.
discover-curiosity-heading = Co rozpala Twoją ciekawość?
discover-curiosity-subheading = Wybierz kilka motywów, które wpadną Ci w oko.
discover-themes-selected =
    { $count ->
        [one] motyw wybrany
        [few] motywy wybrane
        [many] motywów wybranych
       *[other] motywów wybranych
    }
discover-start = Zacznij odkrywać
discover-start-loading = Tworzymy Twoje doświadczenie…
discover-change-later = Zawsze możesz to zmienić później.
explore-header-title = Odkrywaj
explore-header-subtitle = Odkrywaj wyselekcjonowane spacery i ukryte perełki
explore-filter-aria-label = Filtruj trasy
explore-search-placeholder = Szukaj spacerów, miejsc, motywów…
explore-categories-aria-label = Popularne kategorie
explore-featured-heading = Spacer tygodnia
explore-popular-heading = Popularne motywy
explore-curated-heading = Wyselekcjonowane kolekcje
explore-trending-heading = Na topie teraz
explore-community-heading = Ulubieniec społeczności
explore-community-subtitle = Najczęściej udostępniane w tym tygodniu
...
offline-storage-subtitle = Automatycznie usuwaj nieużywane mapy po {$days} dniach
offline-storage-used-label = Wykorzystano
offline-storage-used-description = {$used} z {$total}
...
offline-downloads-undo-aria = {$title} usunięto. Kliknij Cofnij, aby przywrócić tę mapę.
