...
wizard-step-three-start-over = Börja om
wizard-step-three-save-button = Spara promenaden och öppna kartan
wizard-step-three-dialog-title = Promenaden sparades!
wizard-step-three-dialog-description = {$routeTitle} finns nu under dina sparade promenader. Starta rutten nu eller fortsätt utforska andra mästaralternativ.
wizard-step-three-dialog-close = Stäng
wizard-step-three-dialog-view-map = Visa på kartan
wizard-step-three-route-panel-aria = Sammanfattning av slingan med dolda pärlor
...
wizard-step-three-preferences-panel-aria = Dina inställningar har tillämpats
wizard-step-three-preferences-heading = Dina inställningar har tillämpats
wizard-step-three-stops-panel-aria = Utvalda stopp
wizard-step-three-stops-heading = Utvalda stopp
wizard-step-three-highlight-lighting-detail = Trygga kvällspartier med smart belysning
wizard-step-three-highlight-hidden-gems-label = Fokus på dolda pärlor
wizard-step-three-highlight-hidden-gems-detail = Förvänta dig lugna gatukonstgränder och indie-kaféer
wizard-step-three-highlight-loop-label = Slingrande rutt
wizard-step-three-highlight-loop-detail = Börjar och slutar nära din nuvarande plats
wizard-step-three-highlight-easy-label = Låg svårighetsgrad
wizard-step-three-highlight-easy-detail = Mjuka lutningar som passar ett avslappnat tempo
wizard-step-three-stop-cafe-name = Midtown Roastery
wizard-step-three-stop-cafe-description = Espresso i små satser med platser vid fönstret
wizard-step-three-stop-cafe-note = Trevliga baristor, perfekt för take-away
wizard-step-three-stop-art-name = Graffiti Passage
wizard-step-three-stop-art-description = Utomhusgalleri med roterande muraler
wizard-step-three-stop-art-note = Fotopunkt • efter {$distance} {$unit}
wizard-step-three-stop-garden-name = Whispering Oak Garden
wizard-step-three-stop-garden-description = Lugnt pocketpark med skuggiga bänkar
wizard-step-three-stop-garden-note = Vilozon • efter {$distance} {$unit}
wizard-step-three-weather-title = Perfekt promenadväder
wizard-step-three-weather-summary = { $temperature }, { $wind } och { $sky }
wizard-step-three-weather-reminder = Ta med en lätt extra tröja för säkerhets skull.
wizard-step-three-weather-sentiment = Idealiskt
wizard-step-three-weather-wind = lätt bris
wizard-step-three-weather-sky = klar himmel
safety-header-title = Säkerhet och tillgänglighet
safety-header-description = Anpassa dina promenadrutter för extra komfort och trygghet
safety-presets-heading = Förinställda profiler
safety-save-button = Spara preferenser
safety-dialog-title = Preferenser sparade
safety-dialog-description = Dina säkerhets- och tillgänglighetsinställningar används i kommande planering.
safety-dialog-continue = Fortsätt
safety-dialog-chip-fallback = {$id}
safety-preset-alert = Presetet “{$title}” aktiveras i en framtida version.
safety-section-mobility-title = Mobilitetsstöd
safety-section-mobility-description = Ruttjusteringar för enklare navigering
safety-toggle-step-free-label = Rutter utan trappor
safety-toggle-step-free-description = Undvik trappor och trappsteg
safety-toggle-avoid-hills-label = Undvik branta backar
safety-toggle-avoid-hills-description = Begränsa lutningar över 5%
safety-toggle-wider-paths-label = Föredra bredare stigar
safety-toggle-wider-paths-description = Optimerat för stolar, barnvagnar eller grupper
safety-section-safety-title = Säkerhetsfunktioner
safety-section-safety-description = Extra trygghet under promenaden
safety-toggle-busy-areas-label = Föredra livliga områden
safety-toggle-busy-areas-description = Stanna där det finns folk
safety-toggle-emergency-sharing-label = Delning vid nödsituation
safety-toggle-emergency-sharing-description = Dela din position med kontakter
safety-toggle-avoid-isolated-label = Undvik avlägsna områden
safety-toggle-avoid-isolated-description = Hoppa över avskilda platser
safety-section-comfort-title = Komfortinställningar
safety-section-comfort-description = Anpassa promenadupplevelsen efter dig
safety-toggle-shade-label = Prioritera skugga
safety-toggle-shade-description = Välj stigar kantade av träd
safety-toggle-weather-label = Väderanpassad
safety-toggle-weather-description = Justera rutten efter väder
safety-toggle-quiet-label = Föredra tysta rutter
safety-toggle-quiet-description = Minimera trafikbuller
safety-preset-family-title = Familjevänlig
safety-preset-family-description = Lugnt tempo, stopp vid lekplatser, gott om skugga
safety-preset-senior-title = Seniorvänlig
...
walk-complete-hero-description = Fantastiskt äventyr genom staden · { wizard-step-three-route-title }
...
offline-downloads-undo-aria = {$title} borttagen. Tryck på Ångra för att återställa kartan.
