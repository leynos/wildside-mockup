...
customize-crowd-heading = Ìre sluagh
customize-elevation-heading = Roghainn àirde
customize-slider-distance-label = Astar
customize-slider-distance-aria = Sleamhnag astair
...
customize-slider-duration-label = Ùine
customize-slider-duration-aria = Sleamhnag ùine
...
customize-crowd-option-quiet-label = Socair
customize-crowd-option-quiet-description = Sràidean sàmhach
customize-crowd-option-balanced-label = Cothromach
customize-crowd-option-balanced-description = Spionnadh ionadail
customize-crowd-option-lively-label = Beòthail
customize-crowd-option-lively-description = Àiteachan mòr-chòrdte
customize-elevation-option-flat-label = Rèidh
customize-elevation-option-flat-description = Beagan dìreadh
customize-elevation-option-rolling-label = Tonnach
customize-elevation-option-rolling-description = Cnuic shocair
customize-elevation-option-steep-label = Cas
customize-elevation-option-steep-description = Dùbhlain orm
customize-surface-option-paved-label = Air a phàveadh
customize-surface-option-trail-label = Slighe
customize-surface-option-boardwalk-label = Slighe fhiodha
customize-surface-option-mixed-label = Measgachadh
customize-interest-nature-label = Nàdar
customize-interest-history-label = Eachdraidh
customize-interest-food-label = Biadh is deoch
customize-route-preview-route-a-title = Slighe A
customize-route-preview-route-b-title = Slighe B
customize-route-preview-route-c-title = Slighe C
customize-advanced-safety-title = Prìomhachas sàbhailteachd
customize-advanced-safety-description = Slighean soilleir is trang
customize-advanced-accessibility-title = So-ruigsinneachd
customize-advanced-accessibility-description = Slighean gun cheumannan
customize-advanced-download-title = Luchdaich sìos far-loidhne
customize-advanced-download-description = Ro-luchdaich mapaichean is fuaim
nav-map-label = Mapa
...
wizard-step-three-start-over = Tòisich às ùr
wizard-step-three-save-button = Sàbhail an cuairt agus seall am mapa
wizard-step-three-dialog-title = Chaidh an cuairt a shàbhaladh!
wizard-step-three-dialog-description = Tha {$routeTitle} deiseil fo na cuairtean a shàbhail thu. Tòisich air an t-slighe a-nis no lean ort a’ sgrùdadh roghainnean eile an draoidh.
wizard-step-three-dialog-close = Dùin
wizard-step-three-dialog-view-map = Seall air a’ mhapa
wizard-step-three-route-panel-aria = Geàrr-chunntas chuairt nan ulaidhean falaichte
...
wizard-step-three-preferences-panel-aria = Chaidh na roghainnean agad a chur an sàs
wizard-step-three-preferences-heading = Chaidh na roghainnean agad a chur an sàs
wizard-step-three-stops-panel-aria = Stadan sònraichte
wizard-step-three-stops-heading = Stadan sònraichte
wizard-step-three-highlight-lighting-detail = Earrannan oidhche sàbhailte le solais tuigseach
wizard-step-three-highlight-hidden-gems-label = Fòcas air ulaidhean falaichte
wizard-step-three-highlight-hidden-gems-detail = An dùil ri caol-shràidean ciùin agus càbaidean indie
wizard-step-three-highlight-loop-label = Slighe-chearcaill
wizard-step-three-highlight-loop-detail = A’ tòiseachadh is a’ crìochnachadh faisg ort fhèin
wizard-step-three-highlight-easy-label = Ìre dhoirbh furasta
wizard-step-three-highlight-easy-detail = Claonaidhean socair a fhreagras air ruitheam fois
wizard-step-three-stop-cafe-name = Midtown Roastery
wizard-step-three-stop-cafe-description = Espresso baidse-beag le suidheachain ri uinneag
wizard-step-three-stop-cafe-note = Barista càirdeil, air leth math ri thoirt leat
wizard-step-three-stop-art-name = Graffiti Passage
wizard-step-three-stop-art-description = Gailearaidh a-muigh le dealbhan-balla a tha ag atharrachadh
wizard-step-three-stop-art-note = Àite dhealbhan • {$distance} {$unit} a-steach
wizard-step-three-stop-garden-name = Gàrradh Whispering Oak
wizard-step-three-stop-garden-description = Pàirc bheag shàmhach le beingean fo sgàil
wizard-step-three-stop-garden-note = Raon fois • {$distance} {$unit} a-steach
wizard-step-three-weather-title = Sìde foirfe airson coiseachd
wizard-step-three-weather-summary = { $temperature }, { $wind } agus { $sky }
wizard-step-three-weather-reminder = Thoir leat sreathan aotrom airson gach suidheachadh.
wizard-step-three-weather-sentiment = Fìor mhath
wizard-step-three-weather-wind = gaoth bheag
wizard-step-three-weather-sky = speuran soilleir
...
safety-dialog-title = Chaidh na roghainnean a shàbhaladh
safety-dialog-description = Thèid na roghainnean sàbhailteachd is so-ruigsinneachd agad a chur an sàs ann an dealbhadh chuairtean san àm ri teachd.
safety-dialog-continue = Lean air adhart
...
safety-section-mobility-description = Atharraichean slighe gus seòladh a dhèanamh nas fhasa
safety-toggle-step-free-label = Slighean gun cheum
safety-toggle-step-free-description = Seachain staidhrichean is ceumannan
safety-toggle-avoid-hills-label = Seachain cnocan cas
safety-toggle-avoid-hills-description = Cùm claonaidhean fo 5%
safety-toggle-wider-paths-label = Is fheàrr slighean nas leathainne
safety-toggle-wider-paths-description = Air an dèanamh airson cathraichean-cuibhle, bugaidhean no buidhnean
safety-section-safety-title = Feartan sàbhailteachd
safety-section-safety-description = Barrachd tèarainteachd rè do chuairtean
safety-toggle-busy-areas-label = Is fheàrr sgìrean trang
safety-toggle-busy-areas-description = Fuirich ann an raointean far a bheil daoine
safety-toggle-emergency-sharing-label = Co-roinneadh èiginn
safety-toggle-emergency-sharing-description = Co-roinn d’ àite le do luchd-conaltraidh
safety-toggle-avoid-isolated-label = Seachain àiteachan iomallach
safety-toggle-avoid-isolated-description = Leig seachad raointean ro fhàsail
safety-section-comfort-title = Roghainnean comhfhurtachd
...
walk-complete-hero-description = Dàn-thuras iongantach tron bhaile · Hidden Gems Loop
walk-complete-map-alt = Sealladh farsaing den t-slighe a chaidh a chrìochnachadh
walk-complete-badge-route = Slighe crìochnaichte
walk-complete-primary-distance-label = Astar
walk-complete-primary-duration-label = Ùine
walk-complete-secondary-calories-label = Calaraidhean
walk-complete-secondary-stops-label = Stadan
walk-complete-secondary-starred-label = Favouritan
walk-complete-favourite-heading = Amannan as fheàrr leinn
walk-complete-actions-rate = Dèan rangachadh air an cuairt seo
walk-complete-actions-share = Co-roinn
walk-complete-actions-save = Sàbhail an t-slighe
walk-complete-remix-title = Feuch remix?
walk-complete-remix-description = Cruthaich slighe ùr a chumas na h-àiteachan as fheàrr leat agus a lorgas ulaidhean ùra falaichte.
walk-complete-remix-button = Remix an cuairt seo
walk-complete-share-section = Co-roinn an dàn-thuras agad
walk-complete-share-dialog-title = Co-roinn nan rudan sònraichte
walk-complete-share-dialog-description = Às-phortaich bhidio de na stadan agus na stats as fheàrr leat.
walk-complete-share-dialog-cancel = Sguir dheth
walk-complete-share-dialog-generate = Cruthaich bhidio
walk-complete-toast-rating-saved = Tapadh leat! Chaidh an rangachadh a shàbhaladh airson molaidhean san àm ri teachd.
...
offline-storage-subtitle = Sguab às mapaichean nach eil gan cleachdadh às dèidh {$days} latha gu fèin-obrachail
offline-storage-used-label = Air a chleachdadh
offline-storage-used-description = {$used} à {$total}
...
offline-downloads-undo-aria = Chaidh {$title} a sguabadh às. Thoir gnogag air Neo-dhèanadh gus am mapa seo fhaighinn air ais.
...
offline-auto-option-auto-delete-description = Bheir e air falbh mapaichean nas sine na {$days} latha gu fèin-obrachail
