...
customize-slider-duration-marker-0 = 15 mion
customize-slider-duration-marker-1 = 90 mion
customize-slider-duration-marker-2 = 180 mion
...
wizard-step-three-route-duration-unit = mionaidean
wizard-step-three-route-stops-unit = stadan
wizard-step-three-stop-distance-unit = mìltean
