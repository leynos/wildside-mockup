...
wizard-step-three-start-over = Begin opnieuw
wizard-step-three-save-button = Wandeling opslaan en kaart bekijken
wizard-step-three-dialog-title = Wandeling opgeslagen!
wizard-step-three-dialog-description = {$routeTitle} staat klaar bij je opgeslagen wandelingen. Start de route nu of ontdek andere opties van de wizard.
wizard-step-three-dialog-close = Sluiten
wizard-step-three-dialog-view-map = Kaart bekijken
wizard-step-three-route-panel-aria = Samenvatting van de verborgen-parels-lus
wizard-step-three-route-title = Verborgen Parels-lus
...
wizard-step-three-preferences-panel-aria = Je voorkeuren zijn toegepast
wizard-step-three-preferences-heading = Je voorkeuren zijn toegepast
wizard-step-three-stops-panel-aria = Uitgelichte stops
wizard-step-three-stops-heading = Uitgelichte stops
wizard-step-three-highlight-lighting-detail = Veilige avondsegmenten met slimme verlichting
wizard-step-three-highlight-hidden-gems-label = Focus op verborgen parels
wizard-step-three-highlight-hidden-gems-detail = Reken op stille street-artsteegjes en indie-cafés
wizard-step-three-highlight-loop-label = Lusroute
wizard-step-three-highlight-loop-detail = Begint en eindigt dicht bij je huidige locatie
wizard-step-three-highlight-easy-label = Lage moeilijkheid
wizard-step-three-highlight-easy-detail = Geleidelijke hellingen voor een relaxed tempo
wizard-step-three-stop-cafe-name = Midtown Roastery
wizard-step-three-stop-cafe-description = Kleinbatch-espresso met zitplaatsen aan het raam
wizard-step-three-stop-cafe-note = Vriendelijke barista’s, ideaal om mee te nemen
wizard-step-three-stop-art-name = Graffiti Passage
wizard-step-three-stop-art-description = Openluchtgalerie met wisselende muurschilderingen
wizard-step-three-stop-art-note = Fotospot • na {$distance} {$unit}
wizard-step-three-stop-garden-name = Whispering Oak Garden
wizard-step-three-stop-garden-description = Rustig pocketpark met schaduwrijke bankjes
wizard-step-three-stop-garden-note = Rustzone • na {$distance} {$unit}
wizard-step-three-weather-title = Perfect wandelweer
wizard-step-three-weather-summary = { $temperature }, { $wind } en { $sky }
wizard-step-three-weather-reminder = Neem voor de zekerheid een licht laagje mee.
wizard-step-three-weather-sentiment = Ideaal
wizard-step-three-weather-wind = lichte bries
wizard-step-three-weather-sky = heldere lucht
safety-header-title = Veiligheid en toegankelijkheid
safety-header-description = Pas je wandelroutes aan voor extra comfort en veiligheid
safety-presets-heading = Vooraf ingestelde profielen
safety-save-button = Voorkeuren opslaan
safety-dialog-title = Voorkeuren opgeslagen
safety-dialog-description = Je veiligheids- en toegankelijkheidsinstellingen worden voortaan meegenomen in de planning.
safety-dialog-continue = Doorgaan
safety-dialog-chip-fallback = {$id}
safety-preset-alert = De preset “{$title}” wordt in een volgende versie toegepast.
safety-section-mobility-title = Mobiliteitsondersteuning
safety-section-mobility-description = Route-aanpassingen voor makkelijker navigeren
safety-toggle-step-free-label = Routes zonder trappen
safety-toggle-step-free-description = Vermijd trappen en opstapjes
safety-toggle-avoid-hills-label = Vermijd steile hellingen
safety-toggle-avoid-hills-description = Beperk hellingen boven 5%
safety-toggle-wider-paths-label = Geef de voorkeur aan bredere paden
safety-toggle-wider-paths-description = Geoptimaliseerd voor rolstoelen, buggy’s of groepen
safety-section-safety-title = Veiligheidsfuncties
safety-section-safety-description = Extra gemoedsrust tijdens het wandelen
safety-toggle-busy-areas-label = Liever levendige gebieden
safety-toggle-busy-areas-description = Blijf in zones waar mensen zijn
safety-toggle-emergency-sharing-label = Noodlocatie delen
safety-toggle-emergency-sharing-description = Deel je locatie met contacten
safety-toggle-avoid-isolated-label = Vermijd afgelegen plekken
safety-toggle-avoid-isolated-description = Sla verlaten locaties over
safety-section-comfort-title = Comfortinstellingen
safety-section-comfort-description = Maak de wandelervaring geheel op maat
safety-toggle-shade-label = Schaduw prioriteren
safety-toggle-shade-description = Kies paden met bomen
safety-toggle-weather-label = Weeradaptief
safety-toggle-weather-description = Pas routes aan op het weer
safety-toggle-quiet-label = Liever stille routes
safety-toggle-quiet-description = Minimaliseer verkeerslawaai
safety-preset-family-title = Gezinsvriendelijk
safety-preset-family-description = Rustig tempo, speelplaatsstops en voldoende schaduw
safety-preset-senior-title = Seniorvriendelijk
...
walk-complete-hero-description = Geweldig avontuur door de stad · { wizard-step-three-route-title }
...
walk-complete-secondary-stops-label = { wizard-step-three-route-stops-unit }
...
offline-downloads-undo-aria = {$title} verwijderd. Tik op Ongedaan maken om deze kaart terug te zetten.
