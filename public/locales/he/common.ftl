...
customize-crowd-heading = רמת עומס
customize-elevation-heading = העדפת גובה
customize-slider-distance-label = מרחק
customize-slider-distance-aria = מחוון מרחק
...
customize-crowd-option-balanced-description = דופק מקומי
customize-crowd-option-lively-label = תוסס
customize-crowd-option-lively-description = מקומות פופולריים
customize-elevation-option-flat-label = שטוח
customize-elevation-option-flat-description = מעט עליות
customize-elevation-option-rolling-label = גלי
customize-elevation-option-rolling-description = גבעות מתונות
customize-elevation-option-steep-label = תלול
customize-elevation-option-steep-description = אתגרו אותי
customize-surface-option-paved-label = מרוצף
customize-surface-option-trail-label = שביל
customize-surface-option-boardwalk-label = טיילת עץ
customize-surface-option-mixed-label = משולב
customize-interest-nature-label = טבע
customize-interest-history-label = היסטוריה
customize-interest-food-label = אוכל ומשקה
customize-route-preview-route-a-title = מסלול A
customize-route-preview-route-b-title = מסלול B
customize-route-preview-route-c-title = מסלול C
customize-advanced-safety-title = עדיפות בטיחות
customize-advanced-safety-description = מסלולים מוארים ועמוסים
customize-advanced-accessibility-title = נגישות
customize-advanced-accessibility-description = מסלולים ללא מדרגות
customize-advanced-download-title = הורדה לא מקוונת
customize-advanced-download-description = טען מראש מפות ושמע
nav-map-label = מפה
nav-discover-label = גילוי
...
wizard-step-three-start-over = התחילו מחדש
wizard-step-three-save-button = שמרו את המסלול והציגו את המפה
wizard-step-three-dialog-title = המסלול נשמר!
wizard-step-three-dialog-description = {$routeTitle} מחכה תחת המסלולים השמורים שלכם. התחילו אותה עכשיו או המשיכו לחקור אפשרויות נוספות באשף.
wizard-step-three-dialog-close = סגירה
wizard-step-three-dialog-view-map = צפייה במפה
wizard-step-three-route-panel-aria = תקציר לולאת האוצרות הנסתרים
...
wizard-step-three-preferences-panel-aria = ההעדפות שלכם נלקחו בחשבון
wizard-step-three-preferences-heading = ההעדפות שלכם הוחלו
wizard-step-three-stops-panel-aria = עצירות מומלצות
wizard-step-three-stops-heading = עצירות מומלצות
wizard-step-three-highlight-lighting-detail = קטעי ערב בטוחים עם תאורה חכמה
wizard-step-three-highlight-hidden-gems-label = מוקד על אוצרות נסתרים
wizard-step-three-highlight-hidden-gems-detail = צפו בסמטאות שקטות ובבתי קפה אינדיים
wizard-step-three-highlight-loop-label = מסלול מעגלי
wizard-step-three-highlight-loop-detail = מתחיל ומסתיים ליד המיקום הנוכחי שלכם
wizard-step-three-highlight-easy-label = רמת קושי קלה
wizard-step-three-highlight-easy-detail = עליות מתונות בקצב רגוע
wizard-step-three-stop-cafe-name = Midtown Roastery
wizard-step-three-stop-cafe-description = אספרסו בבאצ’ים קטנים עם מושבים בחלון
wizard-step-three-stop-cafe-note = בריסטות ידידותיים, מושלם לטייק־אוויי
wizard-step-three-stop-art-name = Graffiti Passage
wizard-step-three-stop-art-description = גלריית חוץ עם ציורי קיר מתחלפים
wizard-step-three-stop-art-note = נקודת צילום • במרחק {$distance} {$unit}
wizard-step-three-stop-garden-name = Whispering Oak Garden
wizard-step-three-stop-garden-description = פארק כיס שקט עם ספסלים מוצלים
wizard-step-three-stop-garden-note = אזור מנוחה • במרחק {$distance} {$unit}
wizard-step-three-weather-title = מזג אוויר מושלם להליכה
wizard-step-three-weather-summary = { $temperature }, { $wind } ו{ $sky }
wizard-step-three-weather-reminder = ארזו שכבות קלות למקרה הצורך.
wizard-step-three-weather-sentiment = אידאלי
wizard-step-three-weather-wind = בריזה קלה
wizard-step-three-weather-sky = שמיים בהירים
safety-header-title = בטיחות ונגישות
safety-header-description = התאימו את מסלולי ההליכה שלכם לנוחות ולביטחון
safety-presets-heading = פרופילים מוגדרים מראש
safety-save-button = שמירת העדפות
safety-dialog-title = ההעדפות נשמרו
safety-dialog-description = הגדרות הבטיחות והנגישות שלכם יילקחו בחשבון במסלולים עתידיים.
safety-dialog-continue = המשך
safety-dialog-chip-fallback = {$id}
safety-preset-alert = הפרופיל “{$title}” יוחל בגרסה עתידית.
safety-section-mobility-title = תמיכה בניידות
safety-section-mobility-description = התאמות מסלול לניווט קל יותר
safety-toggle-step-free-label = מסלולים ללא מדרגות
safety-toggle-step-free-description = הימנעו ממדרגות ומדרגות קטנות
safety-toggle-avoid-hills-label = הימנעו ממדרונות תלולים
safety-toggle-avoid-hills-description = הגבילו שיפועים מעל 5%
safety-toggle-wider-paths-label = העדיפו שבילים רחבים יותר
safety-toggle-wider-paths-description = מותאם לכיסאות גלגלים, עגלות או קבוצות
safety-section-safety-title = תכונות בטיחות
safety-section-safety-description = יותר ביטחון לאורך ההליכה
safety-toggle-busy-areas-label = העדיפו אזורים עמוסים
safety-toggle-busy-areas-description = הישארו במקומות מאוכלסים
safety-toggle-emergency-sharing-label = שיתוף בשעת חירום
safety-toggle-emergency-sharing-description = שתפו את המיקום שלכם עם אנשי קשר
safety-toggle-avoid-isolated-label = הימנעו ממקומות מבודדים
safety-toggle-avoid-isolated-description = דלגו על נקודות נידחות
safety-section-comfort-title = הגדרות נוחות
safety-section-comfort-description = התאימו את חוויית ההליכה לטעמכם
safety-toggle-shade-label = העדיפו צל
safety-toggle-shade-description = בחרו שבילים עם עצים
safety-toggle-weather-label = מותאם למזג האוויר
safety-toggle-weather-description = התאימו את המסלול לתנאי מזג האוויר
safety-toggle-quiet-label = העדיפו מסלולים שקטים
safety-toggle-quiet-description = צמצמו רעשי תנועה
safety-preset-family-title = מתאים למשפחות
safety-preset-family-description = קצב נינוח, עצירות בגני שעשועים והרבה צל
safety-preset-senior-title = מתאים לבני גיל הזהב
...
walk-complete-hero-description = הרפתקה מדהימה בעיר · { wizard-step-three-route-title }
...
offline-downloads-undo-aria = {$title} נמחק. הקישו על ביטול כדי לשחזר את המפה.
