...
customize-slider-distance-marker-0 = 1 { unit-distance-mile }
customize-slider-distance-marker-1 = 3 { unit-distance-mile }
customize-slider-distance-marker-2 = 6 { unit-distance-mile }
...
wizard-step-two-accessibility-well-lit-description = Prioritize brightly lit evening routes
...
safety-section-comfort-description = Personalize your walking experience
...
offline-downloads-undo-aria = {$title} deleted. Tap undo to restore this map.
