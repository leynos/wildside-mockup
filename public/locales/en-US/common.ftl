...
wizard-step-three-route-description = A personalized walk blending street art laneways, independent cafés, and quiet waterfront viewpoints.
...
safety-preset-alert = Preset “{$title}” will be used for your next walks.
...
safety-toggle-wider-paths-description = Optimized for chairs, buggies, or group walking
...
safety-toggle-shade-label = Prioritize shade
...
safety-toggle-quiet-description = Minimize traffic noise
