...
wizard-step-three-start-over = Dechrau eto
wizard-step-three-save-button = Cadw’r daith a gweld y map
wizard-step-three-dialog-title = Daith wedi’i chadw!
wizard-step-three-dialog-description = Mae {$routeTitle} bellach yn barod o dan eich teithiau wedi’u cadw. Dechreuwch y llwybr nawr neu barhewch i archwilio opsiynau’r dewin.
wizard-step-three-dialog-close = Cau
wizard-step-three-dialog-view-map = Gweld ar y map
wizard-step-three-route-panel-aria = Crynodeb cylch y trysorau cudd
...
wizard-step-three-preferences-panel-aria = Eich dewisiadau wedi’u cymhwyso
wizard-step-three-preferences-heading = Eich dewisiadau wedi’u cymhwyso
wizard-step-three-stops-panel-aria = Stopiau dan sylw
wizard-step-three-stops-heading = Stopiau dan sylw
wizard-step-three-highlight-lighting-detail = Adrannau hwyr diogel gyda goleuadau deallus
wizard-step-three-highlight-hidden-gems-label = Ffocws ar drysorau cudd
wizard-step-three-highlight-hidden-gems-detail = Disgwyl lonydd celf stryd tawel a chaffis indie
wizard-step-three-highlight-loop-label = Llwybr cylchol
wizard-step-three-highlight-loop-detail = Yn dechrau ac yn gorffen ger eich lleoliad presennol
wizard-step-three-highlight-easy-label = Lefel hawdd
wizard-step-three-highlight-easy-detail = Graddiant graddol addas ar gyfer camu hamddenol
wizard-step-three-stop-cafe-name = Midtown Roastery
wizard-step-three-stop-cafe-description = Espresso swp bychan gyda seddi wrth y ffenestr
wizard-step-three-stop-cafe-note = Baristiaid cyfeillgar, delfrydol i fynd â fo
wizard-step-three-stop-art-name = Graffiti Passage
wizard-step-three-stop-art-description = Oriel awyr agored o furluniau cylchdroi
wizard-step-three-stop-art-note = Man tynnu lluniau • {$distance} {$unit} i mewn
wizard-step-three-stop-garden-name = Whispering Oak Garden
wizard-step-three-stop-garden-description = Parc poced tawel gyda meinciau cysgodol
wizard-step-three-stop-garden-note = Ardal orffwys • {$distance} {$unit} i mewn
wizard-step-three-weather-title = Tywydd perffaith ar gyfer cerdded
wizard-step-three-weather-summary = { $temperature }, { $wind }, { $sky }
wizard-step-three-weather-reminder = Paciwch haenau ysgafn rhag ofn.
wizard-step-three-weather-sentiment = Delfrydol
wizard-step-three-weather-wind = awel ysgafn
wizard-step-three-weather-sky = awyr glir
safety-header-title = Diogelwch a Hygyrchedd
safety-header-description = Addaswch eich llwybrau cerdded er mwyn cysur a diogelwch
safety-presets-heading = Proffiliau rhagosodedig
safety-save-button = Cadw dewisiadau
safety-dialog-title = Dewisiadau wedi’u cadw
safety-dialog-description = Bydd eich gosodiadau diogelwch a hygyrchedd bellach yn rhan o gynllunio teithiau yn y dyfodol.
safety-dialog-continue = Parhau
safety-dialog-chip-fallback = {$id}
safety-preset-alert = Bydd y rhagosodiad “{$title}” yn cael ei gymhwyso mewn fersiwn yn y dyfodol.
safety-section-mobility-title = Cefnogaeth symudedd
safety-section-mobility-description = Addasiadau llwybrau i hwyluso llywio
safety-toggle-step-free-label = Llwybrau heb gamau
safety-toggle-step-free-description = Osgoi grisiau a chamfannau
safety-toggle-avoid-hills-label = Osgoi bryniau serth
safety-toggle-avoid-hills-description = Cyfyngu ar lethrau dros 5%
safety-toggle-wider-paths-label = Ffafrio llwybrau ehangach
safety-toggle-wider-paths-description = Wedi’u optimeiddio ar gyfer cadeiriau, bygis neu gerdded mewn grŵp
safety-section-safety-title = Nodweddion diogelwch
safety-section-safety-description = Mwy o sicrwydd i’ch teithiau
safety-toggle-busy-areas-label = Ffafrio ardaloedd prysur
safety-toggle-busy-areas-description = Arhoswch mewn lleoliadau poblog
safety-toggle-emergency-sharing-label = Rhannu mewn argyfwng
safety-toggle-emergency-sharing-description = Rhannwch eich lleoliad â chysylltiadau
safety-toggle-avoid-isolated-label = Osgoi ardaloedd anghysbell
safety-toggle-avoid-isolated-description = Hepgor mannau diarffordd
safety-section-comfort-title = Gosodiadau cysur
safety-section-comfort-description = Personoleuwch eich profiad cerdded
safety-toggle-shade-label = Blaenoriaethu cysgod
safety-toggle-shade-description = Dewiswch lwybrau â choedlinell
safety-toggle-weather-label = Addasu i’r tywydd
safety-toggle-weather-description = Addaswch lwybrau i weddu i’r tywydd
safety-toggle-quiet-label = Ffafrio llwybrau tawel
safety-toggle-quiet-description = Lleihau sŵn traffig
safety-preset-family-title = Addas i deuluoedd
safety-preset-family-description = Trawiad meddal, stopiau maes chwarae a digon o gysgod
safety-preset-senior-title = Addas i oedolion hŷn
...
walk-complete-hero-description = Antur anhygoel drwy’r ddinas · { wizard-step-three-route-title }
...
offline-downloads-undo-aria = Dileuwyd {$title}. Tapiwch Dadwneud i adfer y map hwn.
