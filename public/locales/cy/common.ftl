...
wizard-step-three-route-duration-unit = mun
wizard-step-three-route-stops-unit = stopiau
wizard-step-three-stop-distance-unit = milltir
...
offline-downloads-undo-aria = { offline-downloads-undo-title }. Tapiwch Dadwneud i adfer y map hwn.
