...
safety-toggle-weather-adaptive-label = Addasu i’r tywydd
safety-toggle-weather-adaptive-description = Addaswch lwybrau i weddu i’r tywydd
safety-toggle-quiet-routes-label = Ffafrio llwybrau tawel
safety-toggle-quiet-routes-description = Lleihau sŵn traffig
safety-toggle-well-lit-label = Llwybrau wedi’u goleuo’n dda
safety-toggle-well-lit-description = Blaenoriaethu llwybrau â goleuadau da
